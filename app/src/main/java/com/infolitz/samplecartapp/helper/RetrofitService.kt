...
interface RetrofitService {
   ...
   /* @POST("user/register")
    fun getProfile(@Body profileReq: ModalAgentLogin): Call<AgentLoginListData>
...
*/
  /* @GET("getagent")
   fun getAuthAgentLogin(
       @Header("Authorization") token: String
   ): Call<AgentLoginListData>*/

    @POST("register")
    fun agentRegister(
        @Body updateProfileRequest: ModalAgentRegister
    ): Call<AgentRegisterListData>

    @POST("login")
    fun getAuthAgentLogin(
//        @Header("Authorization") token: String
        @Body modalAgentLogin: ModalAgentLogin  //data given at AgentLoginRepository
    ): Call<AgentLoginListData>
