...
class UserSessionManager(context: Context) {
    ...
    private val mAgentToken = "qwert"
    private val mAgentAdress = "magentaddress"
    ...
    fun setAgentToken(value: String) {
        sharedPreferences.edit().putString(mAgentToken, value).apply()
    }
    fun getAgentToken(): String {
        return sharedPreferences.getString(mAgentToken, "")!!
    }
    ...
    fun setAgentAddress(value: String) {
        sharedPreferences.edit().putString(mAgentAdress, value).apply()
    }
    fun getAgentAddress(): String {
        return sharedPreferences.getString(mAgentAdress, "")!!
    }
